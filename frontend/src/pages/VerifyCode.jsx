...
const VerifyCode = () => {
  ...
  const handleResendCode = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        toast.success("Yeni bir doğrulama kodu gönderildi.");
      } else {
        setError(response.data.message || "Kod gönderimi başarısız oldu.");
      }
    } catch (error) {
      ...
      <div className="relative z-10 w-full max-w-lg px-4 py-8">
        ...
        >
          ...
          <p className="text-center text-gray-300 mb-6">
            Lütfen <span className="text-[#0affd9]">{location.state?.email || 'e-posta adresinize'}</span> gönderilen 6 haneli doğrulama kodunu girin.
          </p>
          ...
          <div className="mt-6 text-center">
            <button 
              ...
              className="text-sm text-[#0affd9] hover:text-[#0affd9]/80 disabled:text-gray-500"
            >
